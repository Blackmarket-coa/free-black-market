...
- [x] JSON-mode examples are syntactically valid JSON snippets (validated via `pnpm -s validate:hermes-prompt`; details in `docs/work-orders/WO-2026-02-hermes-prompt-validation.md`).
- [x] No instructions violate gateway permission model (validated via `pnpm -s validate:hermes-prompt`; details in `docs/work-orders/WO-2026-02-hermes-prompt-validation.md`).
