...
- `toCatalogEntry` in `vendor-quest/service.ts` returns `gatekeeper_links`
  ...
  them, and `packet.ts` prints them under the disclaimer. *Done 2026-09-06.*
