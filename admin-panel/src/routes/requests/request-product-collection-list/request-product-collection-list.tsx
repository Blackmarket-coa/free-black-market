...
import { ProductCollectionRequestDetail } from "@routes/requests/request-product-collection-list/components/product-collection-detail";
        ...
        <Table>
          ...
          <Table.Body>
            {requests?.map((request) => {
              const requestData = request.data as unknown as ProductCollectionDTO;
